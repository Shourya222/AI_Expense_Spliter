...
export default function PersonExpensesPage() {
  ...
  // router.pathname → Current page path (e.g., /profile/[id])
  // router.query → An object with URL query params and dynamic route params
  // router.push(url) → Navigate to a new URL
  // router.replace(url) → Same as push, but replaces the history entry
